...
session_start();
  ...
  if($_POST){
    ...
    $_SESSION['drinkitem'] = $drink;
    header('Location: ./');
  }
    
  if(isset($_GET['id'])){
    $session = $drink[$_GET['id']];
  }else{
    $session = array();
  }
?>
  ...
  <body>
    <div class="container">
        ...
        <div class="page-header">
          <h1>Drinks: <small>Record what you drank today</small></h1>
        </div>
        ...
        <form class="form-horizontal" action="" method="post" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
                  <input type="number" class="form-control" id="txtCalories" name="Calories" placeholder="Calories consumed"  value="<?=$session['Calories']?>">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
              <button type="submit" onclick="window.location.href='https://fall2015menu-n02619263.c9.io/php/Drinks/drinks.php'" class="btn btn-success" id="submit">Record</button>
            </div>
          </div>
        </form>
    </div>
